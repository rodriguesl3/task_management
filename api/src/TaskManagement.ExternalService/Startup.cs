...
using TaskManagement.Repository.Repository;

namespace TaskManagement.ExternalService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IExternalTasksApplication, CheckNameService>();
            services.AddTransient<IExternalTasksRepository, TasksRepository>();
